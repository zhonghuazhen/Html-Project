<%@ Page Language="C#" AutoEventWireup="true" CodeFile="person.aspx.cs" Inherits="Default2" %>
...
<body>
    <form id="form1" runat="server">
        <div class="bg"></div>
    <div>
   <img src="images/jason.jpeg" height="500" width="300">
        </br>
    姓名：钟华振</br></br>
    性别： 男</br></br>
    职业：学生</br></br> 
    所在地：广东湛江</br></br>
    个性签名：命运掌握在自己手里，命运的好坏由自己去创造。</br></br>
    校园官网：<a href="http://www.lingnan.edu.cn/">http://www.lingnan.edu.cn/</a><br>
    </div>
    </form>
